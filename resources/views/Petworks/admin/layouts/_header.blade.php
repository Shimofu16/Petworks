    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            {{-- <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">@yield('tab-title')</li>
            </ol> --}}
            <h6 class="font-weight-bolder text-white mb-0">@yield('tab-title')</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">

            <ul class="navbar-nav  justify-content-end ms-md-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link pr-0" href="#" role="button" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="media d-flex align-items-center text-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
                        ...
                        <a href="#" id="logout-btn" class="dropdown-item" href="#" data-bs-toggle="modal"
